...
public final class ItemUtils extends MinecraftInstance {
    ...
    public static int getEnchantment(ItemStack itemStack, Enchantment enchantment) {
        ...
        for (int i = 0; i < itemStack.getEnchantmentTagList().tagCount(); i++) {
            ...
            if ((tagCompound.hasKey("ench") && tagCompound.getShort("ench") == Enchantment.getEnchantmentID(enchantment)) ||
                    (tagCompound.hasKey("id") && tagCompound.getShort("id") == Enchantment.getEnchantmentID(enchantment)))
