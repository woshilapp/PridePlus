...
public class AstolfoStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.font35.drawString("§l" + panel.getName(), panel.getX() + 2, panel.getY() + 6, Integer.MAX_VALUE);
    }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.getFontHeight() + 3, new Color(26, 26, 26).getRGB());
        GlStateManager.resetColor();
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        GlStateManager.resetColor();
        Fonts.font35.drawString(buttonElement.getDisplayName(), buttonElement.getX() + 3,
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.font35.drawString(moduleElement.getDisplayName(), moduleElement.getX() + 3,
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        GlStateManager.resetColor();
                        Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6,
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                Fonts.font35.drawString(valueOfList, moduleElement.getX() + moduleElement.getWidth() + 14,
                        ...
                        if ((Mouse.isButtonDown(0) && !mouseDown || Mouse.isButtonDown(1) && !rightMouseDown) && mouseX >= moduleElement.getX() + moduleElement.getWidth() +
                            ...
                            if (Mouse.isButtonDown(0)) {
                                for (int i = 0; i < fonts.size(); i++) {
                                    final FontRenderer font = (FontRenderer) fonts.get(i);
