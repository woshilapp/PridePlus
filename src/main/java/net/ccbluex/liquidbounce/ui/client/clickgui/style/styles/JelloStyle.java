...
public class JelloStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.font35.drawString(StringUtils.stripControlCodes(panel.getName()), panel.getX() + 10, panel.getY() - 6, new Color(116,114,115).getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if(moduleElement.getModule().getState()){
            Fonts.font25.drawString("    " + moduleElement.getDisplayName(), moduleElement.getX() + 5, moduleElement.getY() + 3, Color.WHITE.getRGB());
        } else {
            Fonts.font25.drawString("  " + moduleElement.getDisplayName(), moduleElement.getX() + 5, moduleElement.getY() + 3, Color.BLACK.getRGB());
        }
