 ...
 */
@ElementInfo(name = "TomkText")
class TomkText(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
         ...
         */
        fun defaultClient(): TomkText {
            val text = TomkText(x = 2.0, y = 2.0, scale = 2F)
