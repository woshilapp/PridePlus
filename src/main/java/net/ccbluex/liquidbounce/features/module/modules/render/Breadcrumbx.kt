...
@ModuleInfo(name = "Breadcrumbx", category = ModuleCategory.RENDER, description = "skid")
class Breadcrumbx : Module() {
                ...
                when(typeValue.get().toLowerCase()) {
                    ...
                    "rect" -> {
                        if(!(lastPosX==114514.0 && lastPosY==114514.0 && lastPosZ==114514.0)) {
                            ...
                            GL11.glVertex3d(point.x - renderPosX, point.y - renderPosY + mc.player!!.height, point.z - renderPosZ)
                            GL11.glEnd()
                        }
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        // add new points
        if(mc.player!!.ticksExisted % precisionValue.get() != 0) {
