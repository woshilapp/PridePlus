...
class ScoreboardElement(
    ...
    private val rectColorModeValue = ListValue("Rect-Color", arrayOf("Custom"), "Custom")
...
//Shadow!!!!
        ...
        scoreCollection.forEachIndexed { index, score ->
            ...
            FontLoaders.F14.drawStringWithShadow(name, l1.toDouble(), height.toDouble(), listColor)
            if (!noPointValue.get()) {
            ...
            if (index == scoreCollection.size - 1) {
                ...
                GlStateManager.resetColor()
                FontLoaders.F14.drawStringWithShadow(
                    displayName,
