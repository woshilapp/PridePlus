...
class Vape(inst: Target): TargetStyle("Vape", inst, false) {
    ...
    override fun drawTarget(entity: IEntityLivingBase) {
        ...
        Fonts.font30.drawStringWithShadow(entity.name!!, 45 ,
            (17F - Fonts.font30.fontHeight).toInt(), getColor(-1).rgb)
        Fonts.font25.drawString("HP:$heal",98F,20F,Color.white.rgb)
        // head
