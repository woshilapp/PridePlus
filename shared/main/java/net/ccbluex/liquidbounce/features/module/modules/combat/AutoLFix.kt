    ...
    private fun playerChat(name: String) {
        if (enablement.get()) {
            when (mode.get().toLowerCase()) {
                ...
                "heyguy" -> {
                    var a = (Math.random()*8).toInt()
                    when(a){
                        1 -> text = ("Ｌ $name | 嗨，我是风动，这是我的neibu神器，3000买neibu是我的秘密武器，花钱一分钟，赚钱两个月，不要告诉别人哦")
                        2 -> text = ("Ｌ $name | 嗨，我是Pro，这是我的neibu神器，200买30个conf是我的秘密武器，花钱一分钟，赚钱两年半，不要告诉别人哦")
