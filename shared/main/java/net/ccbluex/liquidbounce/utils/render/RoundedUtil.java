...
import net.ccbluex.liquidbounce.utils.ShaderUtil2;
...
import static net.ccbluex.liquidbounce.utils.render.RenderUtils.resetColor;

//import static me.utils.render.RenderUtils.resetColor;

//import static cc.paimon.utils.DrRenderUtils.resetColor;


public class RoundedUtil {

    public static ShaderUtil2 roundedShader = new ShaderUtil2("roundedRect");
    public static ShaderUtil2 roundedOutlineShader = new ShaderUtil2("shaders/roundRectOutline.frag");
    private static final ShaderUtil2 roundedTexturedShader = new ShaderUtil2("shaders/roundRectTextured.frag");
    private static final ShaderUtil2 roundedGradientShader = new ShaderUtil2("roundedRectGradient");
    ...
    public static void drawGradientRound(float x, float y, float width, float height, float radius, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight) {
        ...
        ShaderUtil2.drawQuads(x - 1, y - 1, width + 2, height + 2);
    ...
    public static void drawRoundOutline(float x, float y, float width, float height, float radius, float outlineThickness, Color color, Color outlineColor) {
        ...
        ShaderUtil2.drawQuads(x - (2 + outlineThickness), y - (2 + outlineThickness), width + (4 + outlineThickness * 2), height + (4 + outlineThickness * 2));
    ...
    private static void setupRoundedRectUniforms(float x, float y, float width, float height, float radius, ShaderUtil2 roundedTexturedShader) {
        ScaledResolution sr = new ScaledResolution(Minecraft.getMinecraft());
