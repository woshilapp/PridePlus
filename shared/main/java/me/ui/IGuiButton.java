...
public class IGuiButton {
    ...
    public void draw(int x,int y,int mouseX,int mouseY){
        ...
        RenderUtils.drawImage(rs, x-1,y-1,x+121,y+19);
...
//            RenderUtils.drawRoundRect(x-1,y-1,x+121,y+19,new Color(62,61,64).getRGB());
        ...
        RenderUtils.drawImage(rs, x,y,x+120,y+18);
        FontManager.SFREGULAR18.drawCenteredStringWithShadow(name,x + 120 / 2f,y+(FontManager.SFREGULAR18.getHeight(name) / 2f),net.ccbluex.liquidbounce.utils.render.Colors.WHITE.c);
