package op.lbp.newVer.element.module

import net.ccbluex.liquidbounce.LiquidBounce
import op.lbp.newVer.ColorManager
import op.lbp.newVer.MouseUtils
import op.lbp.newVer.element.components.ToggleSwitch
import op.lbp.newVer.element.module.value.ValueElement
import op.lbp.newVer.element.module.value.impl.BooleanElement
import op.lbp.newVer.element.module.value.impl.FloatElement
import op.lbp.newVer.element.module.value.impl.IntElement
import op.lbp.newVer.element.module.value.impl.ListElement
...
class ModuleElement(val module: Module): MinecraftInstance() {
    ...
    companion object {
        protected val expandIcon = LiquidBounce.wrapper.classProvider.createResourceLocation("wawa/expand.png") }
    ...
    fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, height: Float, accentColor: Color): Float {
        ...
        RenderUtils.drawRoundedRect(x + 9.5F, y + 4.5F, x + width - 9.5F, y + height + animHeight - 4.5F,
            4, ColorManager.buttonOutline.rgb)
        Stencil.write(true)
        RenderUtils.drawRoundedRect(x + 10F, y + 5F, x + width - 10F, y + height + animHeight - 5F, 4, ColorManager.moduleBackground.rgb)
        Stencil.erase(true)
//        RenderUtils.drawRect(x + 10F, y + height - 5F, x + width - 10F, y + height - 4.5F, 4281348144L.toInt())
        ...
        RenderUtils.drawRoundedRect(
                ...
                x + 35F + Fonts.font40.getStringWidth(module.name) +Fonts.font30.getStringWidth(keyName),
                y + height / 2F+4f, 2, BlendUtils.blend(Color(4282729797L.toInt()), Color(219, 219, 219), fadeKeybind.toDouble()).rgb)
